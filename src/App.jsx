...
const BEEF_TIMELINE = [
  {date:"Nov 2023",     event:"FATD Scary Hours Edition — Scary Hours 3",actor:"Drake",   type:"event",   verdict:"cultural", desc:"Four months before 'Like That' publicly launched the beef, Drake released the FATD Scary Hours deluxe. The energy was conspicuously combative — not generic. Drake's lawsuit alleges UMG had knowledge of the deteriorating contract situation during this period. Four months later, Like That dropped. See Preparation Pattern section below."},
  {date:"Mar 22, 2024", event:"Like That",              actor:"Kendrick",type:"shot",    verdict:"opening", desc:"Verse on Future/Metro Boomin track. 'Fuck the Big 3' — public shot directed at Drake and J. Cole. Cole initially responds with '7 Minute Drill', then apologizes and exits. Drake goes silent for weeks."},
  {date:"Apr 19, 2024", event:"Push Ups",               actor:"Drake",   type:"response",verdict:"neutral", desc:"Drake's first official response. Mocks height, fashion, label situation, OVO signings. An early version leaked April 13 via DJ Akademiks; officially dropped April 19. Generally seen as mid-tier by press — not the knockout Drake needed."},
  {date:"Apr 19, 2024", event:"Taylor Made Freestyle",  actor:"Drake",   type:"response",verdict:"loss",    desc:"Released same day as Push Ups. Used AI-generated Tupac and Snoop vocals. Tupac's estate sent cease & desist; Drake removed it. Widely mocked. Media framing: 'Drake can't win without a dead man's voice.'"},
  ...
  {date:"Apr 30, 2024", event:"Euphoria",               actor:"Kendrick",type:"shot",    verdict:"win",     desc:"6+ minute diss. Released April 30 — 11 days after Push Ups, 3 days after signing the Interscope deal. Ghostwriting, height, family, 'not a rap god.' Media reception: unanimous immediate praise from Complex, Rolling Stone, Pitchfork, XXL — within hours of drop, before any serious analysis could occur."},
  {date:"May 3, 2024",  event:"6:16 in LA",             actor:"Kendrick",type:"shot",    verdict:"win",     desc:"Dropped May 3, exclusively on Instagram. Alleges Drake has an informant inside OVO Sound leaking to Kendrick. Short, pressuring, foreshadows Meet the Grahams. Media: another win. Drake had 14 hours to respond before the next wave hit."},
  {date:"May 3, 2024",  event:"Family Matters",         actor:"Drake",   type:"response",verdict:"buried",  desc:"Drake's 12-minute major response, dropped ~14 hours after 6:16 in LA. Allegations about Dave Free, Kendrick's relationship, paternity. Within 20 minutes, Kendrick dropped Meet the Grahams. Family Matters was buried in the same news cycle it tried to dominate."},
  {date:"May 3, 2024",  event:"Meet the Grahams",       actor:"Kendrick",type:"shot",    verdict:"win",     desc:"Dropped ~20 minutes after Family Matters. Addressed to Drake's parents. Secret daughter allegations, sex trafficking claims, letter format. Tactical timing was decisive — media covered MtG and NLU; Family Matters became an afterthought within 24 hours."},
  {date:"May 4, 2024",  event:"Not Like Us",            actor:"Kendrick",type:"shot",    verdict:"cultural",desc:"'Certified pedophile' hook. Released May 4 — the day after the Family Matters/MtG exchange. 71M first-week streams. Became the anthem of 2024. Later: the subject of Drake's core legal and philosophical argument about institutional amplification."},
  {date:"May 5, 2024",  event:"The Heart Part 6",       actor:"Drake",   type:"response",verdict:"loss",    desc:"Drake's final response in the active beef. Denies all allegations, mocks the Euphoria comparisons, claims Kendrick's team fed him false information about the secret daughter. Widely seen as defensive rather than offensive. Drake mostly goes silent after this."},
  {date:"Jun 19, 2024", event:"The Pop Out — Kia Forum",actor:"Kendrick",type:"event",   verdict:"cultural",desc:"Juneteenth concert at the Kia Forum in Inglewood, titled 'Ken & Friends = The Pop Out.' NLU performed multiple times, including 5 times to close the show. New Euphoria lyrics added live: 'Give me Tupac's ring back.' J. Cole made a surprise appearance. Streamed live on Amazon Music. Widely seen as the cultural victory lap."},
  {date:"Jul 4, 2024",  event:"NLU Music Video",        actor:"Kendrick",type:"event",   verdict:"cultural",desc:"Official video released July 4. Aerial Compton shots, OVO owl imagery used as targets, prison cell set referencing Drake's 'Family Matters' video, Whitney and kids visible. Third major cultural wave. Grammy campaign begins in earnest."},
  {date:"Nov 22, 2024", event:"GNX (surprise drop)",    actor:"Kendrick",type:"event",   verdict:"cultural",desc:"Surprise album drop. Timed after Grammy submission window closed for 2025 ceremony, before year-end lists. 'Luther' ft. SZA becomes a crossover smash. GNX consolidates Kendrick's position as the dominant critical and commercial voice of 2024 without reopening the beef directly. The musical victory lap."},
  {date:"Nov 25, 2024", event:"Drake Files Pre-Action Petitions",actor:"Drake",type:"legal",verdict:"filed",desc:"Drake files pre-action petitions in New York (vs UMG + Spotify) and Texas (vs UMG + iHeart) on the same day. Alleges UMG and Spotify artificially inflated NLU by hundreds of millions of streams via bots, playlist manipulation, and payola to iHeart radio. Also alleges podcast hosts and media figures received coordinated compensation to amplify the Kendrick narrative. UMG responds same day: 'offensive and untrue.' Pre-action petitions are not lawsuits — they are a procedural mechanism to obtain discovery before filing."},
  {date:"Jan 15, 2025", event:"Full Defamation Lawsuit Filed",actor:"Drake",type:"legal",verdict:"filed",  desc:"Drake files full federal defamation lawsuit against UMG in the Southern District of New York. Alleges UMG 'approved, published and launched a campaign to create a viral hit out of a rap track intended to convey the specific, unmistakable and false factual allegation that Drake is a criminal pedophile.' Kendrick is not named as a defendant — the suit is against the label that distributed and promoted the song."},
  {date:"Feb 2, 2025",  event:"NLU Wins 5 Grammys",    actor:"Industry",type:"awards",  verdict:"awarded", desc:"Record of the Year · Song of the Year · Best Rap Song · Best Rap Performance · Best Music Video. The Recording Academy awards all five top available categories to a song that courts would later rule contained no literally credible factual claims. The Grammy sweep is a central exhibit in Drake's philosophical argument."},
  {date:"Feb 9, 2025",  event:"Super Bowl LIX Halftime — 133M Viewers",actor:"Industry",type:"event",verdict:"cultural",desc:"Kendrick performs the Super Bowl LIX halftime show — 133.5M viewers, the most-watched halftime show in history. He performs NLU, references the lawsuit mid-show. Seven days after Drake's defamation claims were dismissed, the largest entertainment platform available broadcast those same allegations. Trump attended — first sitting president at a Super Bowl. Full analysis in the Super Bowl section below."},
  {date:"Mar 2025",     event:"Drake Settles with iHeartMedia",actor:"Drake",type:"legal",verdict:"dismissed",desc:"Drake and iHeartMedia reach a private settlement in the Texas payola petition. Terms undisclosed. Drake's attorneys: 'We are pleased that the parties were able to reach a settlement satisfactory to both sides.' The settlement resolves the iHeart action but the UMG defamation lawsuit remains active."},
  {date:"Oct 9, 2025",  event:"UMG Defamation Suit Dismissed",actor:"Drake",type:"legal",verdict:"dismissed",desc:"Federal Judge Jeannette Vargas dismisses Drake's defamation lawsuit against UMG at the pleading stage. Ruling: 'Not Like Us' constitutes hyperbolic artistic expression — 'within the cultural context of a rap battle, the average listener does not reasonably believe the lyrics to be literal accusations of criminal conduct.' No discovery was permitted. UMG internal data, Kendrick's contract, and communications about the NLU campaign were never examined by any court."},
  {date:"Jan 2026",     event:"Drake Files Appeal",     actor:"Drake",   type:"legal",   verdict:"filed",   desc:"Drake files notice of appeal in Manhattan federal court, signaling intent to overturn the dismissal. The appeal is ongoing as of March 2026. If successful, discovery would reopen — giving Drake's team access to UMG internal communications, Kendrick's contract terms, and streaming data that has never been examined in court."},
];
...
export default function App(){
  ...
  return(
    <div style={{background:C.bg,minHeight:"100vh",fontFamily:"Georgia,'Times New Roman',serif",color:"#e8d9a0",paddingBottom:80}}>
      ...
      <div style={{background:"#0d0d0d",borderBottom:`1px solid ${C.border}`,opacity:["rankings","insights","quadrant","data"].includes(tab)?1:0.25,pointerEvents:["rankings","insights","quadrant","data"].includes(tab)?"auto":"none"}}>
