...
const BEEF_TIMELINE = [
  ...
  {date:"May 25, 2024", event:"Kia Forum Show",        actor:"Kendrick",type:"event",  verdict:"cultural",desc:"Live Compton performance. NLU performed multiple times. Photographed imagery of OVO owl. Simultaneous stream event. Second major cultural wave."},
  ...
  return(<>
    ...
    <div style={{marginBottom:22}}>
      {BEEF_TIMELINE.map((e,i)=>(
        <div key={i} style={{display:"flex",gap:12,marginBottom:8,alignItems:"flex-start"}}>
          ...
          <div style={{width:3,background:`${typeColors[e.type]||"#333"}44`,borderRadius:2,flexShrink:0,minHeight:40,position:"relative"}}>
            <div style={{width:3,height:3,borderRadius:"50%",background:typeColors[e.type]||"#333",position:"absolute",top:8,left:0}}/>
          </div>
          <div style={{flex:1,background:C.card,border:`1px solid ${e.type==="flag"?C.red+"44":C.border}`,borderLeft:`2px solid ${typeColors[e.type]||"#333"}`,borderRadius:3,padding:"9px 12px"}}>
            <div style={{display:"flex",alignItems:"center",gap:8,marginBottom:4,flexWrap:"wrap"}}>
              <span style={{fontSize:12,color:e.actor==="Kendrick"?C.purple:e.actor==="Drake"?C.gold:e.actor==="Industry"?"#fbbf24":C.orange,fontStyle:"italic"}}>{e.event}</span>
              <span style={{fontSize:8,color:"#555",background:"#1a1a1a",padding:"1px 6px",borderRadius:10}}>{e.actor}</span>
              {e.verdict&&<span style={{fontSize:9,color:verdictColors[e.verdict]||"#888",background:`${verdictColors[e.verdict]||"#888"}15`,padding:"1px 7px",borderRadius:10}}>{verdictLabels[e.verdict]} {e.verdict}</span>}
    ...
    <div style={{background:C.card,border:`1px solid ${C.red}33`,borderRadius:3,padding:"20px 22px",marginBottom:16}}>
      ...
      {[
        ...
        {n:"2",color:C.orange,title:"Courts ruled the allegations legally non-factual",body:"Drake's defamation claims were dismissed on the grounds that these lyrics constitute hyperbolic artistic expression — the kind of statement 'no reasonable person' would interpret as a literal statement of verifiable fact. The legal system declined to treat them as factual claims."},
        ...
        {n:"6",color:C.red,title:"What ties it together: this is the structure of disinformation",body:"Disinformation doesn't require anyone to believe a false claim. It produces a social verdict independently of whether the claim is true. The court's 'no reasonable person' ruling is the legal articulation of that structure — content engineered to produce an outcome. The institutions each processed the same event through their own logic. The damage survived the disclaimer."},
    ...
    <div style={{marginBottom:20}}>
      ...
      <div style={{background:C.card,border:`1px solid #fbbf2433`,borderRadius:3,padding:"16px 18px",marginTop:6,marginBottom:14}}>
        ...
        <div style={{fontSize:11.5,color:"#7a6a50",lineHeight:2}}>
          NLU's 71M first-week streams made it the largest debut week of any song in Kendrick's career by a factor of roughly 2×. Compare: "luther" ft. SZA — a smooth crossover R&B record from GNX debuted at ~68M first-week streams. A diss track about a specific person and a love song co-led by SZA performing in the same range raises a pointed question: did NLU reach those numbers because of what it was, or because of what was done to amplify it?
        </div>
      </div>

      <div style={{background:C.card,border:`1px solid ${C.orange}22`,borderLeft:`3px solid ${C.orange}`,borderRadius:3,padding:"14px 16px",marginBottom:14}}>
        ...
        <div style={{display:"flex",flexDirection:"column",gap:8}}>
          {[
            ...
            {head:"What the observable pattern shows",body:"In April–May 2024, near-unanimity across hip-hop media: Euphoria was a masterpiece on drop day, Drake's responses were addressed primarily through the lens of how Kendrick responded to them. The consensus formed before analytical distance was possible."},
    ...
    <div style={{background:C.card,border:`1px solid ${C.border}`,borderRadius:3,padding:"16px 18px",marginBottom:20}}>
      <div style={{display:"grid",gridTemplateColumns:"repeat(auto-fill,minmax(280px,1fr))",gap:16}}>
        <div>
          ...
          <div style={{fontSize:11,color:"#5a4a30",lineHeight:1.9}}>Feb 2: Suits dismissed. "Certified pedophile" ruled legally non-factual hyperbole.<br/>Feb 9: Kendrick performs NLU at Super Bowl LIX. 133.5M viewers. Trump in attendance — first sitting president at a Super Bowl.<br/><br/>Seven days. The man the court legally cleared watched a 133M-person singalong of that allegation. Booking predated the beef — but the sequence is documented fact.</div>
        </div>
        <div>
          <div style={{fontSize:10,color:C.teal,letterSpacing:1.5,marginBottom:8,textTransform:"uppercase"}}>The Counterpoint</div>
    ...
    <div style={{marginTop:28,background:"linear-gradient(135deg,#0f0800,#0a0a0a)",border:`1px solid ${C.border}`,borderRadius:3,padding:"22px 24px"}}>
      ...
      {[
        ...
        {color:C.purple, n:"3", head:"The structure is disinformation regardless of intent.",
         body:"Disinformation works when content produces a social verdict independently of whether its claims are true. The press reviewed NLU as art. The Grammys rewarded it as achievement. The courts dismissed it as non-factual. The platforms amplified it to 600M plays. None had to coordinate. The result: a claim that could not be proven in court became treated as settled cultural fact."},
    ...
    <div style={{background:C.bg,minHeight:"100vh",fontFamily:"Georgia,'Times New Roman',serif",color:"#e8d9a0",paddingBottom:80}}>
      <div style={{background:"linear-gradient(180deg,#1c1400 0%,#0a0a0a 100%)",borderBottom:`1px solid ${C.border}`,padding:"22px 20px 16px",textAlign:"center",position:"relative",overflow:"hidden"}}>
        ...
        <div style={{position:"relative"}}>
          ...
          <h1 style={{fontSize:"clamp(17px,4vw,28px)",fontWeight:"normal",color:C.gold,margin:"0 0 4px",letterSpacing:2}}>Streaming Era Observatory</h1>
